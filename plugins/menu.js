...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  if (m.isGroup && !global.db.data.chats[m.chat].menu) {
    throw `*The admin has disabled the menu.*`
  }
  ...
  try {
    ...
    let wit = moment.tz('Africa/Harare').format('HH:mm:ss')
    let wita = moment.tz('Africa/Harare').format('HH:mm:ss')
    ...
    conn.reply(m.chat, 'Sorry, the menu is currently experiencing an error', m)
    throw e
  }
}
